...
namespace dsp
{
    ...
    {
        auto guardIndex = getGuardIndex();
        data[guardIndex] = data[guardIndex - 1];
    }
    ...
    //==============================================================================
    template <typename FloatType>
    [[maybe_unused]] double LookupTableTransform<FloatType>::calculateMaxRelativeError (const std::function<FloatType (FloatType)>& functionToApproximate,
