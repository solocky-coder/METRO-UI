...
struct SequencerTrack
{
    ...
    static std::shared_ptr<SequencerTrack> makeMain() { auto t = std::make_shared<SequencerTrack>(); t->type = TrackType::MainSlice; t->name = "MAIN"; t->colour = juce::Colour (0xFF25D9D9); return t; }
